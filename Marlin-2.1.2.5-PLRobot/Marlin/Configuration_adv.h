 ...
 */
  ...
  //#define INVERT_X2_VS_X_DIR        // X2 direc tion signal is the opposite of X
...
#define HOMING_BUMP_MM      { 5, 5}// changed to 2 axis , 2 }       // (linear=mm, rotational=°) Backoff from endstops after first bump
#define HOMING_BUMP_DIVISOR { 2, 2} //changed to 2 axis, 4 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)
...
#define AXIS_RELATIVE_MODES { false, false}// , false, false } changed to only 2 axis
